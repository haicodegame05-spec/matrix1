...
export const MobileMemoryModal: React.FC<MobileMemoryModalProps> = ({ onClose }) => {
  ...
  const filteredAndSortedMemories = useMemo(() => {
    ...
    result.sort((a, b) => {
      ...
      if (sortBy === 'turn') return b.metadata.turn - a.metadata.turn;
              ...
              filteredAndSortedMemories.map((memory) => (
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[8px] mono text-neutral-600 font-black">Lượt {memory.metadata.turn}</span>
                  </div>
