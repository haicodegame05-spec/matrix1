...
import { Relationship, getAffinityLabel, getLoyaltyLabel, getLustLabel, getLibidoLabel } from '../types';
  ...
  return (
    <div className="p-4 bg-black/40 border border-white/10 rounded-sm mono shadow-lg space-y-4 shrink-0">
      ...
      <div className="grid grid-cols-1 gap-1.5">
        <GoalCard title="Dục vọng (Lust)" field="physicalLust" value={npc.physicalLust} icon="🔥" color="rose" isEditing={isEditing} lastChanges={npc.lastChanges} handleChange={handleChange} npc={npc} onUpdateNpc={onUpdateNpc} />
      ...
      <div className="space-y-2 pt-2 border-t border-white/5">
        <div className="p-2.5 bg-white/[0.02] border border-white/5 rounded-sm space-y-1.5 relative overflow-hidden">
          ...
          {isEditing ? (
            ...
            <p className="text-[11px] text-neutral-400 font-medium italic leading-relaxed">{renderSafeText(npc.background, 'Chưa có thông tin tiểu sử.')}</p>
          )}
        </div>
