...
import { renderSafeText } from './NpcProfileBase';
  ...
  return (
    <div className="space-y-2">
      {npcs.map((npc, idx) => {
        ...
        // Ưu tiên nhãn do người dùng/AI gán thủ công, nếu không có mới dùng logic tự động
                ...
                <div className="flex-grow min-w-0 flex flex-col gap-0">
                  <div className="flex justify-between items-center gap-1">
                    <div className="flex items-center gap-1 min-w-0">
                      ...
                      {isHarem ? (
                        <span className="text-[6px] px-1 bg-pink-500 text-black font-black rounded-sm shrink-0">HAREM</span>
                      ) : isFam ? (
                        <span className="text-[6px] px-1 bg-orange-500 text-black font-black rounded-sm shrink-0">FAMILY</span>
                      ) : null}
