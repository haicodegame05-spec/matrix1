...
1. DỤC VỌNG (PHYSICAL LUST - lust):
   Tập trung vào hưng phấn tức thời, sự thỏa mãn bản năng và các nhu cầu xác thịt bí mật trong phân cảnh hiện tại. Điểm này sẽ giảm mạnh sau khi thỏa mãn.
   - Nhóm Phục tùng: "Muốn bị MC cưỡng đoạt ngay lập tức", "Nghiện cảm giác bị sỉ nhục", "Muốn được làm nô lệ tình dục".
   - Nhóm Chinh phục: "Muốn vắt kiệt MC", "Muốn thống trị giường chiếu", "Khao khát được MC quỳ lạy bú lồn".
   - Nhóm Tha hóa: "Phá vỡ giới hạn loạn luân", "Muốn thực hiện sex công cộng", "Nghiện cảm giác tội lỗi khi ngoại tình".
